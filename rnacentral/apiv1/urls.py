...
urlpatterns = patterns('',
    ...
    url(r'^v1/das/RNAcentral_GRCh37/features/?$', views.DasFeatures.as_view(), name='das-features'),
	url(r'^v1/das/RNAcentral_GRCh37/stylesheet/?$', views.DasStylesheet.as_view(), name='das-stylesheet'),
)
