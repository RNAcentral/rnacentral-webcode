...
ADMINS = (("RNAcentral Team", "".join(["rnacentral", "@", "gmail.com"])),)
...
SECRET_KEY = os.getenv(
    "SECRET_KEY", "use environment variable or override this in local_settings.py"
)
