    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "rfam_clan_id",
                    models.CharField(max_length=20, serialize=False, primary_key=True),
                ),
        ...
        migrations.AddField(
            ...
            name="upi",
            field=models.ForeignKey(
                to="portal.Rna", db_column=b"upi", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="rfamhit",
