    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "database",
                    models.CharField(max_length=30, serialize=False, primary_key=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "upi",
                    models.CharField(
                        max_length=13, serialize=False, primary_key=True, db_index=True
                    ),
                ),
                ("timestamp", models.DateField()),
                ("userstamp", models.CharField(max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created",
                    models.ForeignKey(
                        related_name=b"release_created",
                        db_column=b"created",
                        to="portal.Release",
                        on_delete=models.CASCADE,
                    ),
