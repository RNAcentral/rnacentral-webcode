...
expert_dbs = [
    ...
    },
    {
        ...
        'hint': 'contains high-quality miRNA annotations; miRBase is responsible for assigning official miRNA gene names',
    ...
    },
    {
        ...
        'tags': ['automatic', 'tmRNA', 'prokaryotic'],
        'abbreviation': '',
    ...
    },
    {
        ...
        'tags': ['automatic', 'curated', 'miRNA', 'lncRNA'],
        'abbreviation': '',
        'examples': '',
        'references': [],
        'imported': False,
    ...
    },
    {
        ...
        'hint': 'is an integrated knowledge database dedicated to non-coding RNAs (excluding tRNAs and rRNAs)',
    ...
    },
    {
        ...
        'tags': ['automatic', 'curated', 'interactions'],
        'abbreviation': '',
        'examples': '',
        'references': [],
        'imported': False,
    ...
    },
    {
        ...
        'tags': ['curated', 'experimentally-validated', 'miRNA', 'gene', 'interactions'],
        'abbreviation': '',
        'examples': '',
        'references': [],
        'imported': False,
