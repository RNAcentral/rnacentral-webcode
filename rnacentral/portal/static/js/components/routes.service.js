angular.module("routes", []).service('routes', ['$interpolate', function($interpolate) {
    var routes = {
        ...
        sequenceSearchSubmitJob: '/new-sequence-search/submit-job',
        sequenceSearchJobStatus: '/new-sequence-search/job-status/{{ jobId }}',
        sequenceSearchResults: '/new-sequence-search/job-results/{{ jobId }}',
